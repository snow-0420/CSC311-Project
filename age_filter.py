...
def age_group_scaling():
    student_dict = _load_student_csv(
        os.path.join(os.path.abspath(os.getcwd()), "../data/student_meta.csv"))
    train_dict = _load_train_csv(
        os.path.join(os.path.abspath(os.getcwd()), "../data/train_data.csv"))
